...
class _AnimationPageState extends State<AnimationPage> {
  ...
  double angle = 0;
  String line1 = "8/3";
  String line2 = "Chúc Tỷ luôn xinh đẹp và vui vẻ";
    ...
    return GestureDetector(
      ...
      onTap: () {
        setState(() {
          ...
          if (selected) {
            line1 = "8/3";
            line2 = "Chúc Tỷ mau bớt nọng nha =)))";
          } else {
            line1 = "8/3";
            line2 = "Chúc Tỷ luôn xinh đẹp và vui vẻ";
          }
          angle = (angle + pi) % (2 * pi);
        });
      },
          ...
          child: SizedBox(
            ...
            child: Stack(children: [
              boxAniPos(height / 6, 0, dx, dy, 3, context,
                  "assets/images1/img1.jpg", "assets/images2/img1.jpg"),
              boxAniPos(0, width / 20, dx, dy, 2, context,
                  "assets/images1/img2.jpg", "assets/images2/img2.jpg"),
              boxAniPos(height * 2 / 6, width / 10, dx, dy, 3.5, context,
